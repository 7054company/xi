...
import { 
  ...
  Globe, Zap, Lock, Cloud, Database
} from 'lucide-react';
import { useTheme } from '../../../contexts/ThemeContext';

export const UniverseWelcome = () => {
  ...
  const quickStarts = [
    {
      title: 'REST API',
      icon: Code,
      description: 'Create and manage RESTful APIs',
      color: 'blue'
    },
    {
      title: 'GraphQL',
      icon: Database,
      description: 'Build flexible GraphQL endpoints',
      color: 'purple'
    },
    {
      title: 'WebSocket',
  ...
  const features = [
    ...
    },
    {
      title: 'Analytics',
      icon: Globe,
      description: 'Real-time API usage analytics',
      color: 'blue'
    },
    {
      ...
      <div className={`relative p-8 rounded-2xl overflow-hidden ${
        ...
        <div className="relative">
          ...
          <p className={`text-lg mb-8 ${
            ...
            Build, manage, and share powerful APIs in the digital universe
          </p>
